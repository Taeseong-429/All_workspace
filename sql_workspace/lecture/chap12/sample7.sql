...
-- ------------------------------------------------------
DROP FUNCTION undefined_int;
DROP FUNCTION undefined_short;
DROP FUNCTION undefined_long;
DROP FUNCTION undefined_float;
DROP FUNCTION undefined_double;
DROP FUNCTION undefined_string;
