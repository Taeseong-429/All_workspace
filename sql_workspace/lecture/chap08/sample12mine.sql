...
-- 테이블에 제약조건 추가
ALTER TABLE dept03
ADD CONSTRAINT dept03_deptno_pk PRIMARY KEY(deptno); --? dept03 테이블의 deptno 컬럼에 제약조건 넣은건가 ??
...
-- NOT NULL 제약조건 추가
ALTER TABLE dept03
MODIFY( dname VARCHAR2(15) CONSTRAINT dept03_dname_nn NOT NULL ); --> 컬럼을 처음부터 선언하듯이 컬럼명, 데이터타입, 제약조건 이름 등 다쓰기 !
