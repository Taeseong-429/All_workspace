...
ON emp(ename); --> 인덱스는 만들어질 때 이미 정렬 완성. ename 컬럼에 인덱스 생성.
...
WHERE to_number(empno) = 7369; --> 함수를 씌우면 인덱스가 걸려있어도 사용할 수 없음. --> 풀스캔
WHERE empno != 7369; --> 인덱스가 있어도 쓰지 못하고 풀스캔 ..
